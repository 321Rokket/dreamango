      ...
      <div className="flex h-14 items-center px-3 border-b">
        {!isCollapsed && (
          <div className="flex items-center gap-2 font-semibold">
            <img
              src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/dreamcatchr-logo-white-gVqj73IsCPGk90zSeMrCymMeFW7Rss.png"
              alt="dreamcatchr Logo"
              className="h-8 w-auto"
            />
            <span className="text-lg font-bold text-white">dreamcatchr</span>
          </div>
        )}
        <Button
          variant="ghost"
