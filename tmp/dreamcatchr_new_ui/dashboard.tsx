      ...
      <div className="container mx-auto p-4 relative z-10">
        ...
        <div className="mb-4">
          <Breadcrumb>
            <BreadcrumbList>
              <BreadcrumbItem>
                <BreadcrumbLink href="/" className="text-slate-400 hover:text-slate-100">
              ...
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink href="/dashboard" className="text-slate-400 hover:text-slate-100">
                  Dashboard
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbLink className="text-cyan-400">System Overview</BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
                  ...
                  <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm h-full">
                    <CardContent className="p-4">
                      <nav className="space-y-2">
                        <NavItem icon={Command} label="Dashboard" active href="/dashboard" />
                        <NavItem icon={Activity} label="Diagnostics" href="/diagnostics" />
                        <NavItem icon={Database} label="Data Center" href="/data-center" />
                        <NavItem icon={Globe} label="Network" href="/network" />
                        <NavItem icon={Shield} label="Security" href="/security" />
                        <NavItem icon={Terminal} label="Console" href="/console" />
                        <NavItem icon={MessageSquare} label="Communications" href="/communications" />
                    ...
                    <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm">
                      ...
                      <CardContent>
                        <div className="space-y-4">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              <RadioIcon className="text-cyan-500 mr-2 h-4 w-4" />
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4 grid grid-cols-3 gap-2 text-center">
                      ...
                      <div>
                        ...
                        <div className="text-lg font-mono text-purple-400">{memoryUsage}%</div>
                      </div>
                      <div>
                        <div className="text-xs text-slate-400">Network</div>
                        <div className="text-lg font-mono text-blue-400">{networkStatus}%</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div className="h-64 w-full flex items-center justify-center">
                      <div className="relative w-40 h-40">
                        ...
                        <div
                          className="absolute inset-0 rounded-full border-8 border-transparent border-t-cyan-500"
                          style={{ transform: "rotate(45deg)" }}
                        ></div>
                        <div
                          className="absolute inset-0 rounded-full border-8 border-transparent border-r-purple-500"
                          style={{ transform: "rotate(45deg)" }}
                        ></div>
                        <div
                          className="absolute inset-0 rounded-full border-8 border-transparent border-b-blue-500"
                          style={{ transform: "rotate(45deg)" }}
                        ></div>
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="text-lg font-mono text-slate-100">100%</div>
                        </div>
                      </div>
                    </div>
                    <div className="mt-4 space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm text-slate-400">System Processes</span>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm text-slate-400">User Applications</span>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm text-slate-400">Background Services</span>
                        </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        <Progress value={2} className="h-2 bg-slate-700">
                          <div className="h-full bg-gradient-to-r from-red-500 to-amber-500 rounded-full"></div>
                        </Progress>
                      </div>
                      <div>
                        <div className="flex items-center justify-between mb-1">
                          <div className="text-sm text-slate-400">Response Time</div>
                          <div className="text-sm text-cyan-400">42ms</div>
                        </div>
                      ...
                      <div className="pt-4 border-t border-slate-700/50">
                        <div className="text-xs text-slate-500 mb-2">Health History (30 days)</div>
                        <div className="flex items-center space-x-1">
                          {Array.from({ length: 30 }).map((_, i) => (
                            <div
                              key={i}
                              className={`h-6 w-1 rounded-sm ${Math.random() > 0.1 ? "bg-green-500" : "bg-amber-500"}`}
                            ></div>
                          ))}
                        </div>
                      </div>
                ...
                <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm">
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4 grid grid-cols-4 gap-4">
                      <div className="bg-slate-800/50 rounded-md p-3 border border-slate-700/50">
                        <div className="text-xs text-slate-500 mb-1">Peak CPU</div>
                        <div className="text-lg font-mono text-cyan-400">78%</div>
                        <div className="text-xs text-slate-400">+12% from avg</div>
                      </div>
                      <div className="bg-slate-800/50 rounded-md p-3 border border-slate-700/50">
                        <div className="text-xs text-slate-500 mb-1">Peak Memory</div>
                        <div className="text-lg font-mono text-purple-400">82%</div>
                        <div className="text-xs text-slate-400">+14% from avg</div>
                      </div>
                      <div className="bg-slate-800/50 rounded-md p-3 border border-slate-700/50">
                        <div className="text-xs text-slate-500 mb-1">Peak Network</div>
                        <div className="text-lg font-mono text-blue-400">2.4 GB/s</div>
                        <div className="text-xs text-slate-400">+0.8 GB/s from avg</div>
                      </div>
                      <div className="bg-slate-800/50 rounded-md p-3 border border-slate-700/50">
                        <div className="text-xs text-slate-500 mb-1">Avg Response</div>
                        <div className="text-lg font-mono text-green-400">42ms</div>
                        <div className="text-xs text-slate-400">-8ms from prev</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                    ...
                    <div className="bg-slate-800/30 rounded-lg border border-slate-700/50 overflow-hidden">
                      ...
                      <div className="divide-y divide-slate-700/30">
                        <ReportRow
                          ...
                          size="1.2 MB"
                        />
                        <ReportRow name="Security Audit Log" type="Security" date="Today, 09:15" size="4.5 MB" />
                        <ReportRow
                          ...
                          size="8.7 MB"
                        />
                        <ReportRow name="Resource Utilization" type="Resources" date="Yesterday, 12:30" size="2.3 MB" />
                        <ReportRow name="Error Log Summary" type="Errors" date="2 days ago" size="0.8 MB" />
                        <ReportRow name="User Activity Report" type="Activity" date="3 days ago" size="5.1 MB" />
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div className="space-y-6">
                      <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700/50">
                        <div className="text-sm font-medium text-slate-200 mb-2">System Performance Summary</div>
                        <div className="text-sm text-slate-400">
                          System performance has been stable over the past 7 days with an average CPU utilization of 42%
                          and memory usage of 68%. Network throughput peaked at 2.4 GB/s during high traffic periods.
                          Overall system health is excellent with a 99.98% uptime.
                        </div>
                      </div>

                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700/50">
                          <div className="text-sm font-medium text-slate-200 mb-2">Key Metrics</div>
                          <div className="space-y-2">
                            <div className="flex items-center justify-between">
                              <div className="text-sm text-slate-400">Average CPU</div>
                              <div className="text-sm text-cyan-400">42%</div>
                            </div>
                            <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center justify-between">
                              <div className="text-sm text-slate-400">Peak Network</div>
                              <div className="text-sm text-blue-400">2.4 GB/s</div>
                            </div>
                            <div className="flex items-center justify-between">
                              <div className="text-sm text-slate-400">System Uptime</div>
                              <div className="text-sm text-green-400">99.98%</div>
                            </div>
                          </div>
                        </div>

                        <div className="bg-slate-800/50 rounded-lg p-4 border border-slate-700/50">
                          <div className="text-sm font-medium text-slate-200 mb-2">Recommendations</div>
                          <div className="space-y-2">
                            <div className="text-sm text-slate-400">
                              • Optimize database queries to reduce CPU spikes
                            </div>
                            <div className="text-sm text-slate-400">
                              • Consider memory upgrade for improved performance
                            </div>
                            <div className="text-sm text-slate-400">• Implement load balancing for network traffic</div>
                            <div className="text-sm text-slate-400">
                ...
                <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center justify-between text-sm">
                        <div className="flex items-center space-x-2">
                          <div className="text-slate-400">Filter:</div>
                          <Badge className="bg-cyan-500/20 text-cyan-400 border-cyan-500/50">All</Badge>
                          <Badge className="bg-slate-800/50 text-slate-400 border-slate-700/50">System</Badge>
                          <Badge className="bg-slate-800/50 text-slate-400 border-slate-700/50">Security</Badge>
                          <Badge className="bg-slate-800/50 text-slate-400 border-slate-700/50">Updates</Badge>
                        </div>
                        <div className="text-slate-400">
                          Sort: <span className="text-cyan-400">Newest</span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <NotificationItem
                          title="System Update Available"
                          time="5 minutes ago"
                          description="Version 12.4.5 is ready to install. This update includes security patches and performance improvements."
                          type="update"
                          unread
                        />
                        <NotificationItem
                          ...
                          time="32 minutes ago"
                          description="Unusual login attempt detected from IP 192.168.1.45. The attempt was blocked automatically."
                          type="security"
                          unread
                        />
                        <NotificationItem
                          ...
                          time="1 hour ago"
                          description="CPU usage exceeded 80% for more than 5 minutes. Consider optimizing running processes."
                          type="warning"
                          unread
                        />
                        <NotificationItem
                          title="Backup Completed"
                          time="3 hours ago"
                          description="Scheduled backup to drive E: completed successfully. 1.2TB of data was backed up."
                          type="info"
                        />
                        <NotificationItem
                          title="Network Configuration Changed"
                          time="Yesterday, 18:42"
                          description="Network settings were updated by administrator. New DNS servers configured."
                          type="system"
                        />
                        <NotificationItem
                          title="Storage Alert"
                          time="Yesterday, 14:15"
                          description="Drive C: is running low on space (15% remaining). Consider cleaning up unnecessary files."
                          type="warning"
                        />
                        <NotificationItem
                          title="User Account Created"
                          time="2 days ago"
                          description="New user account 'developer_3' was created with standard permissions."
                          type="system"
                        />
                        <NotificationItem
                          title="Firewall Rules Updated"
                          time="3 days ago"
                          description="Firewall configuration was updated with 3 new rules for enhanced security."
                          type="security"
                        />
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <Label className="text-sm text-slate-400">Security Alerts</Label>
                        </div>
                        <Switch defaultChecked />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <Activity className="text-cyan-500 mr-2 h-4 w-4" />
                          <Label className="text-sm text-slate-400">Performance Warnings</Label>
                        </div>
                        <Switch defaultChecked />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <Download className="text-cyan-500 mr-2 h-4 w-4" />
                          <Label className="text-sm text-slate-400">System Updates</Label>
                        </div>
                        <Switch defaultChecked />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <HardDrive className="text-cyan-500 mr-2 h-4 w-4" />
                          <Label className="text-sm text-slate-400">Storage Alerts</Label>
                        </div>
                        <Switch defaultChecked />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          <Users className="text-cyan-500 mr-2 h-4 w-4" />
                          <Label className="text-sm text-slate-400">User Account Changes</Label>
                        </div>
                        <Switch />
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <Label className="text-sm text-slate-400">Communication Updates</Label>
                        </div>
                        <Switch defaultChecked />
                      </div>
                      ...
                      <div className="pt-4 border-t border-slate-700/50">
                        <div className="flex items-center justify-between">
                          <div className="text-sm text-slate-400">Notification Method</div>
                          <div className="flex items-center space-x-2">
                            <Badge className="bg-cyan-500/20 text-cyan-400 border-cyan-500/50">System</Badge>
                            <Badge className="bg-slate-800/50 text-slate-400 border-slate-700/50">Email</Badge>
                            <Badge className="bg-slate-800/50 text-slate-400 border-slate-700/50">Push</Badge>
                          </div>
                        </div>
                      </div>
                    </div>
...
function NavItem({
  ...
  return (
    <Link href={href}>
      <Button
        variant="ghost"
        className={`w-full justify-start px-4 ${active ? "bg-slate-800/70 text-cyan-400" : "text-slate-400 hover:text-slate-100"}`}
      >
...
function ReportRow({
  ...
  return (
    <div className="grid grid-cols-12 py-3 px-3 text-sm hover:bg-slate-800/50">
      ...
      <div className="col-span-2 text-slate-400">{size}</div>
      <div className="col-span-2 flex space-x-2">
        <Button variant="ghost" size="sm" className="h-8 px-2 text-cyan-400 hover:text-cyan-300 hover:bg-slate-800">
          View
        </Button>
        <Button variant="ghost" size="sm" className="h-8 px-2 text-slate-400 hover:text-slate-300 hover:bg-slate-800">
...
function NotificationItem({
  ...
  time: string
  description: string
  type: "info" | "warning" | "error" | "success" | "update" | "security" | "system"
  unread?: boolean
}) {
  const getTypeStyles = () => {
    switch (type) {
      ...
      case "update":
        return { icon: Download, color: "text-cyan-500 bg-cyan-500/10 border-cyan-500/30" }
      case "security":
        return { icon: Shield, color: "text-purple-500 bg-purple-500/10 border-purple-500/30" }
      case "system":
        return { icon: Settings, color: "text-slate-400 bg-slate-400/10 border-slate-400/30" }
      default:
        return { icon: Info, color: "text-blue-500 bg-blue-500/10 border-blue-500/30" }
    }
  }
  ...
  return (
    <div
      className={`flex items-start space-x-3 p-3 rounded-md ${unread ? "bg-slate-800/50 border border-slate-700/50" : ""}`}
    >
      <div className={`mt-0.5 p-1.5 rounded-full ${color.split(" ")[1]} ${color.split(" ")[2]}`}>
...
function Radio(props) {
  return (
    <div
      {...props}
      className={`${props.className} w-4 h-4 rounded-full border-2 border-current flex items-center justify-center`}
    >
